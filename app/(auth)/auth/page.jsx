          ...
          <div className="bg-[#222a3d]/60 backdrop-blur-2xl p-8 rounded-[2.5rem] shadow-2xl border border-white/5 space-y-8">
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              {!isLogin && (
                <div className="space-y-2 group animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="relative flex items-center bg-[#060e20] rounded-xl border border-[#45464d]/30 transition-all duration-300 focus-within:border-[#adc6ff]/40">
                    ...
                    />
                    <input
                      className="w-full bg-transparent border-none py-4 pl-12 pr-4 text-[#dae2fd] placeholder:text-[#45464d]/60 focus:ring-0 text-sm"
                      id="name"
              ...
              <div className="space-y-2 group">
                ...
                <div className="relative flex items-center bg-[#060e20] rounded-xl border border-[#45464d]/30 transition-all duration-300 focus-within:border-[#adc6ff]/40">
                  <Mail className="absolute left-4 text-[#909097]" size={18} />
                  <input
                    className="w-full bg-transparent border-none py-4 pl-12 pr-4 text-[#dae2fd] placeholder:text-[#45464d]/60 focus:ring-0 text-sm"
                    id="email"
              ...
              <div className="space-y-2 group">
                ...
                <div className="relative flex items-center bg-[#060e20] rounded-xl border border-[#45464d]/30 transition-all duration-300 focus-within:border-[#adc6ff]/40">
                  <Lock className="absolute left-4 text-[#909097]" size={18} />
                  <input
                    className="w-full bg-transparent border-none py-4 pl-12 pr-12 text-[#dae2fd] placeholder:text-[#45464d]/60 focus:ring-0 text-sm"
                    id="password"
                    placeholder="••••••••••••"
              ...
              {/* Submit Button */}
              <button className="w-full group relative flex items-center justify-center py-4 bg-linear-to-br from-[#adc6ff] to-[#357df1] text-[#002e6a] font-bold rounded-xl overflow-hidden shadow-xl transition-all active:scale-[0.98] mt-4">
